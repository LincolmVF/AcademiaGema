...
import { useAuth } from '../context/AuthContext'; // Para usar datos reales
  ...
  return (
    <div className="min-h-screen bg-[#f1f5f9] flex justify-center relative overflow-hidden">
      ...
      <div className="w-full md:max-w-6xl p-4 md:p-8 pb-28 relative z-10">
        ...
        {/* --- ESTADÍSTICAS (Ahora resaltan más) --- */}
        <div className="mb-10">
            <StudentStats />
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 items-start">
          ...
          {/* COLUMNA IZQUIERDA: Horario / Clases */}
          ...
          <div className="space-y-8">
             <div className="bg-white p-6 rounded-3xl shadow-xl shadow-slate-200/60 border border-slate-100 md:sticky md:top-8">
